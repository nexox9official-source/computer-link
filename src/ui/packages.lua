...
local FALLBACK = {
  {id='tasks',title='Mes taches',version='1.1',description='Checklist personnelle sauvegardee.'},
  {id='stopwatch',title='Chronometre',version='1.1',description='Chrono avec pause et remise a zero.'},
  {id='units',title='Convertisseur',version='1.1',description='Distance, temperature et temps.'},
  {id='devices',title='Peripheriques',version='1.1',description='Inspecter les appareils et inventaires.'},
  {id='calendar',title='Calendrier',version='1.1',description='Heure et jour du monde Minecraft.'},
  {id='system',title='Infos systeme',version='1.1',description='Etat local du Computer et de ses peripheriques.'},
  {id='redstone',title='Controle Redstone',version='1.1',description='Piloter les sorties redstone du poste local.'},
  {id='gps',title='GPS',version='1.1',description='Localiser le Computer avec le reseau GPS.'}
}
M.catalog = FALLBACK
